...
public class Constants {
    ...
    public final static List<String> INVENTORY = Arrays.asList("mouse", "headphone", "computer", "laptop", "mobile", "keyboard", "mac", "dell", "hp", "microsoft",
            "kitchen", "mug", "cup", "bottle", "painting","furniture","pot","ceiling fan","plant","bed","vase","houseplant","table","curtain","nightstand",
    "drawer","drawer","bed sheet","television0","chair","Studio couch");
}
